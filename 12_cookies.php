...
// Set a cookie
setcookie('name','Adekunle',time()+86400*30);  // set the variable , value and time for the cookie expiring time for the cookie
...
//to delete cookie
setcookie('name','',time()-86400); // unset the variable
